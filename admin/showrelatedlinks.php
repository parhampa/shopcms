...
<head>
    ...
    <title>نمایش لینک های مرتبط</title>
                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            <?php
                            $sql = "select * from related_links order by order_s";
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="http://<?php echo($fild["link"]); ?>"><?php echo($fild["link"]); ?></a></td>
                                    <td><?php echo($fild['order_s']); ?></td>
                                    <td>
                                        <button class="btn btn-info color-block"><i class="fa fa-pencil"></i> مشاهده
                                        </button>
                                        <a href="editlink.php?id=<?php echo($fild['id']); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="deletelink.php?id=<?php echo($fild['id']); ?>">
