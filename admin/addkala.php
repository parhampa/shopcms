    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                ...
                ?>
                <form action="addkala1.php?user=<?php echo($user); ?>" method="post" enctype="multipart/form-data">
                    <script>
                        function markall() {
                    ...
                    <div class="form-group">
                        ...
                        <select name="cat" id="cat" title="cat" class="form-control" onchange="loadcatforms(this.value)">
                            <?php
