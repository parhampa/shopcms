    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <div>
                    <a href="show_numeric_item.php?cat=<?php echo($cat_id); ?>">
                ...
                ?>
                <form action="edit_numeric_item1.php?cat_id=<?php echo($cat_id); ?>&id=<?php echo($id); ?>"
                      method="post"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="is_important" name="is_important">
                            <option value="0" <?php
                            if ($fild['is_important'] == 0) {
                                echo("selected");
                            }
                            ?>>خیر
                            </option>
                            <option value="1" <?php
                            if ($fild['is_important'] == 1) {
                                echo("selected");
                            }
                            ?>>بله
                            </option>
                    ...
                    <div class="form-group">
                        <label for="order_show">ترتیب نمایش آیتم</label>
                        <input type="number" class="form-control" id="order_show" name="order_show"
                               value="<?php echo($fild['order_show']); ?>">
                    </div>

                    <div class="form-group">
                        <label for="is_money">این ورودی مبلغ است ؟</label>
                        <select class="form-control" id="is_money" name="is_money">
                            <option value="0" <?php
                            if ($fild['is_money'] == 0) {
                                echo("selected");
                            }
