        ...
        <div class="row">
            <div class="col-md-10 formadmin">
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <script>
                            function showkala() {
                                ...
                                url = "addpackrow.php?fi=" + datatxt + "&user=" + "<?php echo ($user);?>" + "&lastid=" + "<?php echo ($lastid);?>" ;
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $pid = $fild['id'];
                                        $sql2 = "select * from packrow where `Pid` = $pid and `type` = 0  and `PAid`=$lastid and `user`='$user'";
                                        $res2 = mysqli_query($connection,$sql2);
                                        if(mysqli_num_rows($res2)>0){
                                            $fild2 = mysqli_fetch_assoc($res2);
                                            ?>
                                            <a href="deletepackrow.php?id=<?php echo($fild2['id']); ?>&PAid=<?php echo($lastid); ?>&user=<?php echo($user); ?>&pg=0">
                                            ...
                                            <a href="addpackrow1.php?ty=0&Pid=<?php echo($fild['id']); ?>&PAid=<?php echo($lastid); ?>&user=<?php echo($user); ?>&pg=0">
                        ...
                        <script>
                            function showkhadamat() {
                                ...
                                url = "addpackrow.php?fi1=" + datatxt +"&user=" + "<?php echo ($user);?>" + "&lastid=" + "<?php echo ($lastid);?>" ;
                                location.replace(url);
                            }
                        </script>
                        <div class="form-group pull-right">
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $pid = $fild['id'];
                                        $sql2 = "select * from packrow where `Pid` = $pid and `type` = 1 and `PAid`=$lastid and `user`='$user'";
                                        $res2 = mysqli_query($connection,$sql2);
                                        if(mysqli_num_rows($res2)>0){
                                            $fild2 = mysqli_fetch_assoc($res2);
                                            ?>
                                            ...
                                            <a href="addpackrow1.php?ty=1&Pid=<?php echo($fild['id']); ?>&PAid=<?php echo($lastid); ?>&user=<?php echo($user); ?>&pg=0">
                                                <button class="btn btn-success"><i class="fa fa-plus"></i>افزودن به پکیج
                                                </button>
                                            </a>
                                            <?php
                        ...
                        <?php
                        $sum = "";
                        $sqlqr = "select * from kala where id in (select Pid from packrow where PAid = $lastid and `type`=0)";
                        ...
                        $sqlqr1 = "select * from khadamat where id in (select Pid from packrow where PAid = $lastid and `type`=1)";
                        ...
                        ?>
                        <br>
                        <form method="post" action="updatepricepack.php?id=<?php echo($lastid); ?>&user=<?php echo ($user);?>&sum=<?php echo($sum1+$sum2); ?>">
                    ...
                    <div class="col-md-3" style="height: 400px;background: silver ">
                        <ul><h5 style="font-weight: bold;">کالا</h5>
                            ...
                            while($feild = mysqli_fetch_assoc($resu)){
                                ...
                                <li>
                                    <?php
                                    $proid = $feild['Pid'];
                                    $qr = "select * from kala where id = $proid";
                                    $resu1 = mysqli_query($connection,$qr);
                                    $feild1 = mysqli_fetch_assoc($resu1);
                                    echo($feild1['title']);
                                    ?>
                                    <span><a href="deletepackrow.php?id=<?php echo($feild['id']); ?>&PAid=<?php echo($lastid); ?>&user=<?php echo($user); ?>&pg=0" style="color:red;">x</a></span>
                                </li>
                                <?php
                        ...
                        <ul><h5 style="font-weight: bold;">خدمات</h5>
                            ...
                            while($feild = mysqli_fetch_assoc($resu)){
                                ...
                                <li>
                                    <?php
                                    $proid = $feild['Pid'];
                                    $qr = "select * from khadamat where id = $proid";
                                    $resu1 = mysqli_query($connection,$qr);
                                    $feild1 = mysqli_fetch_assoc($resu1);
                                    echo($feild1['title']);
                                    ?>
