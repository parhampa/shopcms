    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                ...
                <form action="edit_string_item1.php?id=<?php echo($id); ?>&cat_id=<?php echo($cat_id); ?>" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="order_string" name="order_string"
                               value="<?php echo($fild['order_string']); ?>">
                    </div>
