...
if(isset($_GET['id'])==false){
    msg("مطلبی انتخاب نشده است." , $back);
    die();
}
$id = sqlint($_GET['id']);
if($id == ""){
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-9 formadmin">
                <form action="editcontent1.php?id=<?php echo($fild['id']); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control" id="short_content" name="short_content"><?php echo($fild['short_content']);?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control" id="long_content" name="long_content"><?php echo($fild['long_content']);?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="keywords"
                                   name="keywords" value="<?php echo($fild['keywords']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select id="category" name="category" class="form-control">
                                <?php
                                $sql1 = "select * from content_cat where `Fid`=0";
                                $res1 = mysqli_query($connection, $sql1);
                                while ($fild1 = mysqli_fetch_assoc($res1)) {
                                    ?>
                                    <option value="<?php echo($fild1['id']); ?>" <?php if($fild['category']== $fild1['id']){
                                        echo ("selected");
                                        } ?>><?php echo ($fild1['name']);?>
                                    </option>
                                    <?php
                                    ...
                                    while($fild2 = mysqli_fetch_assoc($res2)){
                                        ?>
                                        <option value="<?php echo ($fild2['id']);?>"<?php
                                            if($fild2['id']==$fild['category']){
                                                echo("selected");
                                            }?>>
                                        &nbsp;&nbsp;&nbsp;&nbsp;- <?php echo($fild2['name']); ?></option>
                                        <?php
                                    }
                                }
                                ?>
                        ...
                        if ($fild['pic'] != "") {
                            ...
                            <div id="logophoto" class="col-xs-6" style="position: relative;">
                                <a style="position: absolute; top: 0; right: 0;"
                                   href="deletepiccontent.php?id=<?php echo($fild['id']); ?>">
                                    <i class="fa fa-close"></i>
                                </a>
                                <img src="<?php echo($fild['pic']); ?>" width="128px" height="128px">
                            </div>
                        <?php } ?>
