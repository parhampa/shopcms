...
<head>
    ...
    <title>نمایش آیتم های متنی</title>
            ...
            <div class="col-md-10 m-auto">
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        <div>
                            <a href="add_string_item.php?cat=<?php echo($cat_id); ?>">
                        ...
                        <table class="table table-striped table-bordered table-list">
                            ...
                            $sql = "select * from `item_string` where `cat_id` = $cat_id";
                            $res = mysqli_query($connection, $sql);
                            if (mysqli_num_rows($res) == 0) {
                                ?>
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_string_item.php?cat_id=<?php echo($cat_id); ?>&id=<?php echo($fild['id']); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="delete_string_item.php?id=<?php echo($fild3['id']); ?>">
