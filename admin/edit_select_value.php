...
<head>
    ...
    <title>افزودن مقدار آیتم انتخابی</title>
        ...
        <div class="col-sm-12">
            <div class="page-header">
                <div class="page-title">
                    <h1>افزودن مقدار آیتم انتخابی</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <div>
                    <a href="show_select_value.php?cat_id=<?php echo($cat_id); ?>&sid=<?php echo($sid); ?>">
                ...
                <form action="edit_select_value1.php?cat_id=<?php echo($cat_id); ?>&id=<?php echo($id); ?>&sid=<?php echo($sid); ?>"
                      method="post"
                      enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="title">عنوان مقدار</label>
                        <input type="text" class="form-control" id="title" name="title"
                               value="<?php echo($fild['title']); ?>">
                    </div>

                    <div class="form-group">
                        <label for="order_val">ترتیب نمایش مقدار</label>
                        <input type="number" class="form-control" id="order_val" name="order_val"
                               value="<?php echo($fild['order_val']); ?>">
                    </div>

                    <div class="form-group col-md-12 btn-form">

                        <button type="submit" class="btn btn-primary">ویرایش مقدار آیتم</button>
