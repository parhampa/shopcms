                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        ...
                        <div class="form-group pull-right">
                            <input type="text" class="search form-control" placeholder="جستجو آیتم ها ">
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            <?php
                            $sql = "select * from item_menu order by order_s";
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo($fild["order_s"]); ?></td>
                                    <td><?php echo($fild["title"]); ?></td>
                                    <td><?php echo($fild["link"]); ?></td>
                                    <td>
                                        <a href="edititemmenu.php?id=<?php echo($fild['id']); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="deleteitemmenu.php?id=<?php echo($fild['id']); ?>">
