...
$sql = "select * from jashnvare WHERE id = $id";
$res = mysqli_query($connection,$sql);
if(mysqli_num_rows($res)==0){
    msg("جشنواره ای وجود ندارد." , $back);
    die();
}
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <form action="editjashnvare1.php?id=<?php echo ($fild['id']);?>" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="percent" value="<?php echo ($fild['percent']);?>" name="percent">
                    </div>
