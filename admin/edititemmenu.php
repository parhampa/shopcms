...
$id = sqlint($_GET['id']);
$sql = "select * from item_menu where id = $id";
$res = mysqli_query($connection, $sql);
if(mysqli_num_rows($res) == 0){
    ?>
    <script>
        alert("آیتمی وجود ندارد...");
        location.replace("showitemmenus.php");
    </script>
    <?php
    die();
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <form action="edititemmenu1.php?id=<?php echo ($fild['id']);?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="order_s" name="order_s" value="<?php echo ($fild['order_s']);?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        if($fild['logo'] != ""){
                            ...
                            <div style="position: relative;">
                                <a style="position: absolute; top: 0; right: 0;" href="deleteitemimage.php?id=<?php echo ($fild['id']);?>">
                                    <i class="fa fa-close"></i>
                                </a>
                                <img src="<?php echo ($fild['logo']);?>" width="200px" height="200px" />
