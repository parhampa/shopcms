...
<head>
    ...
    <title>نمایش اسلایدهای جشنواره</title>
                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        ...
                        <div class="form-group pull-right">
                            <input type="text" class="search form-control" placeholder="جستجو اسلاید">
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            <?php
                            $sql = "select * from jashnvare_slider";
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editjashnvareslide.php?id=<?php echo($fild['id']); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="deletejashnvareslide.php?id=<?php echo($fild['id']); ?>">
