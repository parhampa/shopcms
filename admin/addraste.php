    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <form action="addraste1.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="title">عنوان رسته</label>
                        <input type="text" class="form-control" id="title" name="title">
                    </div>

                    <div class="form-group">
                        <label for="ra_order">ترتیب نمایش رسته</label>
                        <input type="number" class="form-control" id="ra_order" name="ra_order">
                    </div>

                    <div class="form-group col-md-12 btn-form">

                        <button type="submit" class="btn btn-primary">درج رسته</button>
