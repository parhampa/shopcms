                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        ...
                        <div class="form-group pull-right">
                            <input type="text" class="search form-control" placeholder="جستجو منو ">
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            <?php
                            $sql = "select * from menu order by order_s";
                              ...
                              $count++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editmenu.php?id=<?php echo($fild['id']); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="deletemenu.php?id=<?php echo($fild['id']); ?>">
