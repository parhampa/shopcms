    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 formadmin">
                <div class="row">
                    <div class="col-md-9">
                        <form action="editpack1.php?user=<?php echo($user);?>&id=<?php echo($id); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <span style="margin-bottom: 30px; padding: 10px; border: solid 1px gray; border-radius: 10px;">
                                ...
                                <?php
                                $sum = "";
                                $sqlqr = "select * from kala where id in (select Pid from packrow where PAid = $id and `type`=0)";
                                ...
                                $sqlqr1 = "select * from khadamat where id in (select Pid from packrow where PAid = $id and `type`=1)";
                            ...
                            <div class="form-group">
                                ...
                                if($picture != ""){
                                    ...
                                    <div style="position: relative;">
                                        <a style="position: absolute; top: 0; right: 0;" href="deletepackimage.php?id=<?php echo ($id);?>&user=<?php echo($user);?>">
                        ...
                        <?php
                            ...
                            while($feild = mysqli_fetch_assoc($resu)){
                                ...
                                <?php
                                    ...
                                    echo($feild1['title']);
                                    ?>
                                 <span><a href="deletepackrow.php?id=<?php echo($feild['id']); ?>&PAid=<?php echo($id); ?>&user=<?php echo($user); ?>&pg=1" style="color:red;">x</a></span>
                                </li>
            ...
            <div class="col-md-10 formadmin">
                <script>
                    function showkala() {
                        ...
                        url = "editpack.php?fi=" + datatxt + "&user=" + "<?php echo ($user);?>" + "&id=" + "<?php echo ($id);?>" ;
                    ...
                    while ($fild = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $pid = $fild['id'];
                                $sql2 = "select * from packrow where `Pid` = $pid and `type` = 0 and PAid = $id";
                                $res2 = mysqli_query($connection,$sql2);
                                if(mysqli_num_rows($res2)>0){
                                    $fild2 = mysqli_fetch_assoc($res2);
                                    ?>
                                    <a href="deletepackrow.php?id=<?php echo($fild2['id']); ?>&PAid=<?php echo($id); ?>&user=<?php echo($user); ?>&pg=1">
                                    ...
                                    <a href="addpackrow1.php?ty=0&Pid=<?php echo($fild['id']); ?>&PAid=<?php echo($id); ?>&user=<?php echo($user); ?>&pg=1">
                ...
                <script>
                    function showkhadamat() {
                        ...
                        url = "editpack.php?fi1=" + datatxt +"&user=" + "<?php echo ($user);?>" + "&id=" + "<?php echo ($id);?>" ;
                        location.replace(url);
                    }
                </script>
                <div class="form-group pull-right">
                    ...
                    while ($fild = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $pid = $fild['id'];
                                $sql2 = "select * from packrow where Pid = $pid and `type` = 1 and PAid = $id";
                                $res2 = mysqli_query($connection,$sql2);
                                if(mysqli_num_rows($res2)>0){
                                    $fild2 = mysqli_fetch_assoc($res2);
                                    ?>
                                    ...
                                    <a href="addpackrow1.php?ty=1&Pid=<?php echo($fild['id']); ?>&PAid=<?php echo($id); ?>&user=<?php echo($user); ?>&pg=1">
                                        <button class="btn btn-success"><i class="fa fa-plus"></i>افزودن به پکیج
                                        </button>
                                    </a>
                                    <?php
