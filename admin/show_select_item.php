...
<head>
    ...
    <title>نمایش آیتم های انتخابی</title>
            ...
            <div class="col-md-10 m-auto">
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        <div>
                            <a href="add_select_item.php?cat=<?php echo($cat_id); ?>">
                                <button class="btn btn-info color-block">+ افزودن آیتم
                                </button>
                            </a>
                        ...
                        <table class="table table-striped table-bordered table-list">
                            ...
                            $sql = "select * from `item_select` where `cat_id` = $cat_id";
                            $res = mysqli_query($connection, $sql);
                            if (mysqli_num_rows($res) == 0) {
                                ?>
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo($fild['order_select']); ?></td>
                                    <td>
                                        <a href="edit_select_item.php?cat_id=<?php echo($cat_id); ?>&id=<?php echo($fild['id']); ?>">
                                        ...
                                        <a href="show_select_value.php?cat_id=<?php echo($cat_id); ?>&sid=<?php echo($fild['id']); ?>">
                                            <button class="btn btn-info color-block">مشاهده مقادیر
                                            </button>
                                        </a>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="delete_select_item.php?id=<?php echo($fild3['id']); ?>">
