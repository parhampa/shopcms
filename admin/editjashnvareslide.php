...
$id = sqlint($_GET['id']);
$sql = "select * from jashnvare_slider where id = $id";
...
<head>
    ...
    <title>ویرایش اسلاید جشنواره</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <form action="editjashnvareslide1.php?id=<?php echo ($fild['id']);?>" method="post" enctype="multipart/form-data">
