                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-list">
                            ...
                            <tbody>
                            <?php
                            $sql = "select * from jashnvare order by id DESC ";
                            if (isset($_GET['user']) == true) {
                                $user = sqlstr($_GET['user']);
                                $sql = "select * from jashnvare where `user`='$user' order by id DESC ";
                            }
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $usershop = $fild['user'];
                                        $sqlshop="select * from users where `user`='$usershop'";
                                        $resshop=mysqli_query($connection,$sqlshop);
                                        $fildshop=mysqli_fetch_assoc($resshop);
                                        echo($fildshop['title']);
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="editjashnvare.php?id=<?php echo($fild['id']); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="deletejashnvare.php?id=<?php echo($fild['id']); ?>">
