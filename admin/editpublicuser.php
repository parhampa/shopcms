...
if (isset($_GET['user']) == false) {
    ...
    <script>
        ...
        location.replace("showpublicusers.php");
    </script>
    <?php
    die();
}
...
$sql = "select * from public_user where `user` = '$user'";
...
?>
    ...
    <head>
        ...
        <title>ویرایش کاربر عمومی </title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 formadmin">
                    <form action="editpublicuser1.php?user=<?php echo($fild['user']); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="postal_code" name="postal_code"
                                   value="<?php echo($fild['postal_code']); ?>">
                        </div>
