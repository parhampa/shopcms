            ...
            <div class="w3-col s12">
                <div class="w3-row">
                    ...
                    while ($fildasnaf = mysqli_fetch_assoc($ressenf)) {
                        $senfid = $fildasnaf['id'];
                        $sqlkala = "select * from kala where `user` in (select `user` from `users` where `senfid`=$senfid) order by id desc limit 10";
                                        ...
                                        <div class="owl-carousel owl-theme show_slide2">
                                            ...
                                            while ($fildkala = mysqli_fetch_assoc($reskala)) {
                                                ...
                                                <div class="item hover-card-m">
                                                    <a href="singel-kala.php?id=<?php echo($fildkala['id']); ?>">
