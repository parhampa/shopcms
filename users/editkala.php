    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <form action="editkala1.php?id=<?php echo($fild['id']); ?>" method="post" enctype="multipart/form-data">
                    <script>
                        function markall() {
                    ...
                    <div>
                        ...
                        while ($fildraste = mysqli_fetch_assoc($resraste)) {
                            ...
                            <span style="margin: 5px;">
                                <?php
                                $raid = $fildraste['id'];
                                $sqlpostch = "select * from `post_raste` where `pid`=$id and `ty`=0 and `rid`=$raid";
                    ...
                    <div class="form-group">
                        ...
                        <select name="cat" id="cat" title="cat" class="form-control"
                            ...
                            <?php
                            $sqlcat = "select * from `content_cat` where `ty`=0 and `Fid`=0";
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="brand" name="brand"
                               value="<?php echo($fild['brand']); ?>">
                    </div>

                    <div class="form-group">
                        <label for="model">مدل</label>
                        <input type="text" class="form-control" id="model" name="model"
                               value="<?php echo($fild['model']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="colors">رنگ های موجود</label>
                        <input type="text" class="form-control" id="colors" name="colors"
                               value="<?php echo($fild['colors']); ?>">
                    </div>
                    <div id="restxt">
                        <?php
                        ...
                        while ($fildstring = mysqli_fetch_assoc($resstring)) {
                            ...
                            $sqlstringval = "select * from `post_string` where `pid`=$id and `string_id`=$string_id and `ty`=0";
                        ...
                        while ($fildselect = mysqli_fetch_assoc($resselect)) {
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="select<?php echo($fildselect['id']); ?>"
                                    ...
                                    <?php
                                    $sid = $fildselect['id'];
                                    $sqlselect_val = "select * from `post_select` where `select_id`=$sid and `pid`=$id and `ty`=0";
                    ...
                    <div id="resnumeric">
                        ...
                        while ($fildnumeric = mysqli_fetch_assoc($resnumeric)) {
                            ...
                            $sqlnumval = "select * from `post_numeric` where `ty`=0 and `pid`=$id and `numeric_id`=$numeric_id";
                        ...
                        while ($fildbig = mysqli_fetch_assoc($resbig)) {
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="bigtxt<?php echo($fildbig['id']); ?>"
                                    ...
                                    $sqlbigval = "select * from `post_string` where `pid`=$id and `ty`=0 and `string_id`=$string_id";
                    ...
                    <div class="form-group">
                        <label for="describ">توضیحات</label>
                        <textarea type="text" class="form-control" id="describ"
                                  name="describ"><?php echo($fild['describ']); ?></textarea>
                    </div>
                        ...
                        if ($fild['pic'] != "") {
                            ...
                            <div style="position: relative;">
                                <a style="position: absolute; top: 0; right: 0;"
                                   href="deletekalaimage.php?id=<?php echo($fild['id']); ?>">
