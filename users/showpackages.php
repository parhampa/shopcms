                    ...
                    <div class="panel-body">
                        <script>
                            function showpackage() {
                                datatxt = document.getElementById('txtpack').value;
                                url = "showpackages.php?fi=" + datatxt;
                                location.replace(url);
                            }
                        </script>
                        <div class="form-group pull-right">
                            <input type="text" id="txtpack" class="search form-control" placeholder="جستجو پکیج ">
                        </div>

                        <div class="form-group pull-right">
                            <button class="search btn btn-secondary" onclick="showpackage();"> اعمال</button>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            $sql = "select * from pack where `user`='$user' $fi order by id desc";
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editpack.php?id=<?php echo($fild['id']); ?>&user=<?php echo ($fild['user']);?>">
...
<?php
$sql = "select * from pack where `user`='$user' order by id desc";
$res = mysqli_query($connection, $sql);
$count = 0;
while ($fild = mysqli_fetch_assoc($res)) {
    ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="deletepack.php?id=<?php echo($fild['id']); ?>">
