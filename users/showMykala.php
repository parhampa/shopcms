                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            $sql = "select * from kala where `user` = '$user' $fi order by id desc";/* session of user must be set */
...
<?php
$sql = "select * from kala where `user` = '$user' order by id desc"; /* session of user must be set */
$res = mysqli_query($connection, $sql);
$count = 0;
while ($fild = mysqli_fetch_assoc($res)) {
    ?>
