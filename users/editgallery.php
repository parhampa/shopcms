...
$id = sqlint($_GET['id']);
$sql = "select * from gallery where id = $id and `user`='$user'";
$res = mysqli_query($connection, $sql);
if(mysqli_num_rows($res) == 0){
    ?>
    <script>
        alert("تصویری وجود ندارد...");
        location.replace("showgallery.php");
    </script>
    <?php
    die();
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 formadmin">
                <form action="editgallery1.php?id=<?php echo ($fild['id']);?>" method="post" enctype="multipart/form-data">
