...
$sql = "update kala set `cat_id`=$cat_id,`title`='$title',`brand`='$brand',`describ`='$describ',`model`='$model',`price`=$price ,`tarikh`='$tarikh',`colors`='$colors' $picq where id = $id and `user`='$user'";
$res = mysqli_query($connection, $sql);
if ($res) {
    $lastid = $id;
    ////////////////////////del befor raste
    $sql2 = "delete from `post_raste` where `pid`=$id and `ty`=0";
    ...
    ///////////////////////delete text
    $sql2 = "delete from `post_string` where `pid`=$id and `ty`=0";
    $res2 = mysqli_query($connection, $sql2);
    ///////////////////////add text
    ...
    ///////////////////delete numeric
    $sql2 = "delete from `post_numeric` where `pid`=$id and `ty`=0";
    $res2 = mysqli_query($connection, $sql2);
    ///////////////////add numeric
    ...
    //////////////////delete select
    $sql2 = "delete from `post_select` where `pid`=$id and `ty`=0";
    $res2 = mysqli_query($connection, $sql2);
    //////////////////add select
