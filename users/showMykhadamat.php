                    ...
                    <div class="panel-body">
                        <script>
                            function showkhadamat() {
                                ...
                                url = "showMykhadamat.php?fi=" + datatxt;
                        ...
                        <table class="table table-striped table-bordered table-list table-responsive-xl results">
                            ...
                            $sql = "select * from khadamat WHERE `user` = '$user' $fi order by id desc";/* session of user must be set */
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        //$user1 = $fild['user'];
                                        $sql1 = "select `title` from users where `user` = '$user'";
...
<?php
$sql = "select * from khadamat where `user` = '$user' order by id desc";/* session of user must be set */
$res = mysqli_query($connection, $sql);
$count = 0;
while ($fild = mysqli_fetch_assoc($res)) {
    ?>
