                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-list">
                            ...
                            <tbody>
                            <?php
                            $sql = "select * from aghsat where `pid` in (select id from kala where `user`='$user') or `pid` in (select id from khadamat where `user`='$user') order by id desc ";
                            ...
                            while ($fild = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $pid = $fild['Pid'];
                                        $sqlt = "select * from kala where id=$pid and `user`='$user'";
                                        if ($fild['ty'] == 1) {
                                            $sqlt = "select * from khadamat where id=$pid and `user`='$user'";
                                        }
                                        $rest = mysqli_query($connection, $sqlt);
                                        $fildt = mysqli_fetch_assoc($rest);
                                        echo($fildt['title']);
                                        ?>
                                    </td>
