...
$sql = "insert into users (`user`,`pass`,`mob`,`tel`,`title`,`logo`,`header`,`addres`,`senfid`,`name`,`famili`,`describ`,`u_bazaryab`,`introduction`,`telegram`,`instagram`,`linkedIn`)
VALUES ('$user','$pass','$mob','$tel','$title','$logo','$header','$address',$senfid,'$name','$famili','$describ','$u_bazaryab','$introduction','$telegram','$instagram','$linkedIn')";
$res = mysqli_query($connection, $sql);
if ($res) {
