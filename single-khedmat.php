...
<head>
    <meta charset="UTF-8">
    <title><?php echo($fild['title']); ?></title>
    ...
    <div class="w3-container w3-margin-top">
        ...
        <div class="w3-row">
            <div class="w3-col m5 s12 relative">
                <?php
                $tarikh = date("Y-m-d");
                $sql4 = "select * from offer_product where `type`=1 and `Pid`=$id and `end_date`>=$tarikh order by id desc";
                ...
                if ($fild['pic'] != "") {
                    ...
                    ?>
                    <img src="template/img/Non-photo2.png"
                         class="w3-image w3-responsive img-kala">
                    <?php
                }
                ?>
            ...
            <div class="w3-col m6 s12 box-margin">
                ...
                <?php
                $sql5 = "select * from aghsat where `ty`=1 and `Pid`=$id order by id desc";
